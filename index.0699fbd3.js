...
var _pictureDefault = parcelHelpers.interopDefault(_picture);
var _wow = require("./wow");
var _wowDefault = parcelHelpers.interopDefault(_wow);
var _form = require("./form");
var _formDefault = parcelHelpers.interopDefault(_form);
var _jqueryValidation = require("jquery-validation");
var _additionalMethods = require("jquery-validation/dist/additional-methods");
// Example usage
(0, _jqueryDefault.default)(()=>{
    // Initialize all plugins
    (0, _plugins.initPlugins)();
    // Destroy all plugins
    // destroyPlugins();
    // setTimeout(destroyPlugins, 5000);
    // Form handler
    (0, _jqueryDefault.default)(".app__form").on("submit", (e)=>{
        e.preventDefault();
    });
    // Find the element to observe for lazy loading using jQuery
    const $picture = (0, _jqueryDefault.default)("#app__picture");
    // Start observing the picture
    (0, _pictureDefault.default).observe($picture[0]);
    // Find text
    const $appText = (0, _jqueryDefault.default)(".app__text");
    // WOW - add class for text when it is in the viewport
    (0, _wowDefault.default).observe($appText[0]);
    // Form validation
    (0, _formDefault.default)((0, _jqueryDefault.default)("#app__form"));
});

},{"jquery":"hgMhh","./plugins":"9eSUx","./picture":"j7wnw","./wow":"79rTQ","./form":"l9hyy","jquery-validation":"2RFON","jquery-validation/dist/additional-methods":"ekKro","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"9eSUx":[function(require,module,exports) {
...
parcelHelpers.export(exports, "destroyPlugins", ()=>destroyPlugins);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _sticker = require("./jquery-plugins/sticker");
var _click = require("./jquery-plugins/click");
// Function to call plugins on elements with data-plugin attribute
function callPlugins(callback) {
    (0, _jqueryDefault.default)("[data-plugin]").each(function() {
        const $element = (0, _jqueryDefault.default)(this);
        ...
        plugins.forEach((plugin)=>{
            if (plugin in $element) callback($element, plugin);
        });
    });
}
...
},{"jquery":"hgMhh","./jquery-plugins/sticker":"1rW8O","./jquery-plugins/click":"bU7B7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1rW8O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
// jQuery sticker plugin
(0, _jqueryDefault.default).fn.stickerPlugin = function(options) {
    // Default plugin settings
    const defaults = {
        stickerClass: "stickered"
    };
    // Merge default settings with provided options
    const settings = (0, _jqueryDefault.default).extend({}, defaults, options);
    const stickerHandler = (element)=>{
        const scrollTop = (0, _jqueryDefault.default)(window).scrollTop();
        if (scrollTop) // Set class
    ...
    const init = ()=>{
        ...
        (0, _jqueryDefault.default)(window).on("scroll", stickerHandler.bind(null, (0, _jqueryDefault.default)(this)));
    };
    // Plugin destruction logic
    const destroy = function() {
        // Remove class & remove eventListener
        (0, _jqueryDefault.default)(this).removeClass(settings.stickerClass);
        (0, _jqueryDefault.default)(window).off("scroll", stickerHandler);
    };
    // Depending on the provided command, call the corresponding method
    if (options === "destroy") destroy.call(this);
    else init.call(this);
...
},{}],"bU7B7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
// jQuery click plugin
(0, _jqueryDefault.default).fn.clickPlugin = function(options) {
    // Default plugin settings
    const defaults = {
        clickClass: "clicked"
    };
    ...
    const init = function() {
        // Toggle class
        (0, _jqueryDefault.default)(this).on("click", function() {
            (0, _jqueryDefault.default)(this).toggleClass("clicked");
        });
    };
    // Plugin destruction logic
    const destroy = function() {
        // Remove class & remove eventListener
        (0, _jqueryDefault.default)(this).removeClass(settings.clickClass).off("click");
    };
    // Depending on the provided command, call the corresponding method
    if (options === "destroy") destroy.call(this);
    else init.call(this);
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j7wnw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
function lazyLoadImage(entry) {
    if (entry.isIntersecting) {
        ...
        const $images = (0, _jqueryDefault.default)(entry.target).find("img");
        const $sources = (0, _jqueryDefault.default)(entry.target).find("source");
        // Set the source attributes to start loading each image
        $sources.each(function() {
            (0, _jqueryDefault.default)(this).attr("srcset", (0, _jqueryDefault.default)(this).data("srcset")).removeAttr("data-srcset");
        });
        $images.each(function() {
            (0, _jqueryDefault.default)(this).attr("src", (0, _jqueryDefault.default)(this).data("src")).removeAttr("data-src");
        });
...
exports.default = pictureObserver;

},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"79rTQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
function wowHandler(entry) {
    if (entry.isIntersecting) {
        const target = (0, _jqueryDefault.default)(entry.target);
        // Add class
...
// Create an Intersection Observer with a 10% threshold
const wow = new IntersectionObserver((entries)=>{
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l9hyy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>initializeFormValidation);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
(0, _jqueryDefault.default)(()=>{
    (0, _jqueryDefault.default).validator.addMethod("phoneValidation", function(value, element) {
        return this.optional(element) || /^(\+\d{1,})?\d{5,}$/.test(value);
    }, "Invalid phone number.");
});
function initializeFormValidation(form) {
    (0, _jqueryDefault.default)(form).validate({
        rules: {
            requiredField: {
                required: true
            },
        ...
        submitHandler: (form)=>{
            ...
            (0, _jqueryDefault.default)("#app__form").fadeOut("slow", ()=>{
                (0, _jqueryDefault.default)("#successMessage").fadeIn("slow");
            });
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2RFON":[function(require,module,exports) {
/*!
 ...
 */ (function(factory) {
    ...
    else if (0, module.exports) module.exports = factory(require("7fabe1c7b320cd67"));
    else factory(jQuery);
})(function($) {
    $.extend($.fn, {
...
},{"7fabe1c7b320cd67":"hgMhh"}],"ekKro":[function(require,module,exports) {
/*!
 * jQuery Validation Plugin v1.20.0
 *
 * https://jqueryvalidation.org/
 ...
 */ (function(factory) {
    ...
    else if (0, module.exports) module.exports = factory(require("d1d468d94840a61c"));
    else factory(jQuery);
})(function($) {
    (function() {
 ...
 */ $.validator.addMethod("cifES", function(value, element) {
        ...
        if (letter.match(/[ABEH]/)) return control === control_digit;
        else if (letter.match(/[KPQS]/)) return control === control_letter;
        // Can be either
 ...
 */ $.validator.addMethod("cnhBR", function(value) {
        ...
        if (new Array(12).join(firstChar) === value) return false;
        ...
        sum = 0;
        for(i = 0, j = 1, v = 0; i < 9; ++i, ++j)sum += +(value.charAt(i) * j);
        secondCN = sum % 11;
        if (secondCN >= 10) secondCN = 0;
        else secondCN = secondCN - dsc;
 ...
 */ $.validator.addMethod("cpfBR", function(value, element) {
        ...
        if (value === "" || value === "00000000000" || value === "11111111111" || value === "22222222222" || value === "33333333333" || value === "44444444444" || value === "55555555555" || value === "66666666666" || value === "77777777777" || value === "88888888888" || value === "99999999999") return false;
        // Step 1 - using first Check Number:
 ...
 */ $.validator.addMethod("dateITA", function(value, element) {
        ...
        if (re.test(value)) {
            ...
            if (xdata.getUTCFullYear() === aaaa && xdata.getUTCMonth() === mm - 1 && xdata.getUTCDate() === gg) check = true;
            else check = false;
        } else check = false;
 ...
 */ $.validator.addMethod("giroaccountNL", function(value, element) {
    ...
    $.validator.addMethod("greaterThan", function(value, element, param) {
        var target = $(param);
        if (this.settings.onfocusout && target.not(".validate-greaterThan-blur").length) target.addClass("validate-greaterThan-blur").on("blur.validate-greaterThan", function() {
            $(element).valid();
        });
        return value > target.val();
    ...
    $.validator.addMethod("greaterThanEqual", function(value, element, param) {
        var target = $(param);
        if (this.settings.onfocusout && target.not(".validate-greaterThanEqual-blur").length) target.addClass("validate-greaterThanEqual-blur").on("blur.validate-greaterThanEqual", function() {
            $(element).valid();
        });
        return value >= target.val();
    }, "Please enter a greater value.");
 ...
 */ $.validator.addMethod("iban", function(value, element) {
    ...
    $.validator.addMethod("lessThan", function(value, element, param) {
        var target = $(param);
        if (this.settings.onfocusout && target.not(".validate-lessThan-blur").length) target.addClass("validate-lessThan-blur").on("blur.validate-lessThan", function() {
            $(element).valid();
        });
        return value < target.val();
    ...
    $.validator.addMethod("lessThanEqual", function(value, element, param) {
        var target = $(param);
        if (this.settings.onfocusout && target.not(".validate-lessThanEqual-blur").length) target.addClass("validate-lessThanEqual-blur").on("blur.validate-lessThanEqual", function() {
            $(element).valid();
        });
        return value <= target.val();
    }, "Please enter a lesser value.");
    ...
    $.validator.addMethod("maxfiles", function(value, element, param) {
        if (this.optional(element)) return true;
        if ($(element).attr("type") === "file") {
            if (element.files && element.files.length > param) return false;
        }
        return true;
    ...
    $.validator.addMethod("maxsize", function(value, element, param) {
        if (this.optional(element)) return true;
        if ($(element).attr("type") === "file") {
            if (element.files && element.files.length) for(var i = 0; i < element.files.length; i++){
        ...
        if ($(element).attr("type") === "file") {
            if (element.files && element.files.length) {
                ...
                for(var i = 0; i < element.files.length; i++){
                    ...
                    if (totalSize > param) return false;
                }
            }
        }
        return true;
 ...
 */ $.validator.addMethod("nieES", function(value, element) {
        ...
        // Quick format test
        if (value.length > 10 || value.length < 9 || !nieRegEx.test(value)) return false;
        // X means same number
 ...
 */ $.validator.addMethod("nifES", function(value, element) {
        ...
        // Basic format test
        if (!value.match("((^[A-Z]{1}[0-9]{7}[A-Z0-9]{1}$|^[T]{1}[A-Z0-9]{8}$)|^[0-9]{8}[A-Z]{1}$)")) return false;
        // Test NIF
 ...
 */ $.validator.addMethod("nipPL", function(value) {
        ...
        var intSum = 0;
        for(var i = 0; i < 9; i++)intSum += arrSteps[i] * value[i];
        var int2 = intSum % 11;
 ...
 */ $.validator.addMethod("stateUS", function(value, element, options) {
        ...
        if (!includeTerritories && !includeMilitary) regex = "^(A[KLRZ]|C[AOT]|D[CE]|FL|GA|HI|I[ADLN]|K[SY]|LA|M[ADEINOST]|N[CDEHJMVY]|O[HKR]|PA|RI|S[CD]|T[NX]|UT|V[AT]|W[AIVY])$";
        else if (includeTerritories && includeMilitary) regex = "^(A[AEKLPRSZ]|C[AOT]|D[CE]|FL|G[AU]|HI|I[ADLN]|K[SY]|LA|M[ADEINOPST]|N[CDEHJMVY]|O[HKR]|P[AR]|RI|S[CD]|T[NX]|UT|V[AIT]|W[AIVY])$";
        else if (includeTerritories) regex = "^(A[KLRSZ]|C[AOT]|D[CE]|FL|G[AU]|HI|I[ADLN]|K[SY]|LA|M[ADEINOPST]|N[CDEHJMVY]|O[HKR]|P[AR]|RI|S[CD]|T[NX]|UT|V[AIT]|W[AIVY])$";
        else regex = "^(A[AEKLPRZ]|C[AOT]|D[CE]|FL|GA|HI|I[ADLN]|K[SY]|LA|M[ADEINOST]|N[CDEHJMVY]|O[HKR]|PA|RI|S[CD]|T[NX]|UT|V[AT]|W[AIVY])$";
...
},{"d1d468d94840a61c":"hgMhh"}]},["1SICI"], "1SICI", "parcelRequire94c2")

//# sourceMappingURL=index.0699fbd3.js.map
